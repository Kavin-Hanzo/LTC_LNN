...
class GRUModel(BaseModel):
    ...
    def __init__(
        ...
        super(GRUModel, self).__init__(input_dim, hidden_size, output_dim)
...
def build_gru(config: dict, input_dim: int) -> GRUModel:
    """
    Factory function — builds GRUModel from config dict.
    """
    return GRUModel(
        input_dim=input_dim,
